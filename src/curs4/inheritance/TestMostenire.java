...
public class TestMostenire {
	...
	public static void main(String[] args) {
		...
		System.out.println("Numele testerului este :" + tester.getNume() + ", face parte din"+ "departamentul" + tester.getDepartament() + "este de nivel senioritate" + tester.getSenioritate() + "si scrie teste automate folosind"+ tester.getLimbajProgramare() );
